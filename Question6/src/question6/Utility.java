...
public class Utility 
{
    ...
    */
     ...
     * 
     * @param p
     * sort pairs in inc order of happiness
     */
   
    void SortPairsIncOdr(Pairs p[])
    {
        CalculateHappiness(p);
     ...
     * @param p
     * @param t 
     * breakUp of pairs having happiness less than t
     */
    void BreakUp(Pairs p[],int t)
    {
     ...
     */
    void AssignNewBF(Pairs p[],Boy b[])
    {
       int l=0;
       
       System.out.println("Pair(G,B)_index" + "  " +"GIRLFRIEND"+ "  " +"BOYFRIEND" );
